...
<head>
    ...
    <link href="css/editarEstilo.css" rel="stylesheet">
</head>
    ...
    <div class="row divRow">
        <div class="col-sm-8 divCol">
            ...
            if (isset($_GET['id'])) {
                ...
                echo "<br>";
                $_SESSION['tmdb_id'] = $data['id'];
                $_SESSION['titulo'] = $data['title'];
                $_SESSION['estado'] = 'A';
                $_SESSION['estreno'] = $data['release_date'];
                $_SESSION['overview'] = $data['overview'];
            }
            ?>
            <div class="divFi">

                <button id="fiButton" onclick='window.location.href="borrar_peli.php";'>Borrar</button>
        ...
        <div class="col-sm-4">
            <img id="imgPel" src="<?php echo 'https://image.tmdb.org/t/p/w300/' . $data['poster_path'] . '?api_key=a741455342cf023e81ade2e9b630b605' ?>" alt="">
        </div>
    </div>
